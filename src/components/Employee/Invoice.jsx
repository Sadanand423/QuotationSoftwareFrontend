    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-2">Generate invoices from approved quotations</p>
        </div>
      </div>
      ...
      {!showForm ? (
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-4">
            <h3 className="text-xl font-bold text-white flex items-center">
              ...
              Approved Quotations Ready for Invoice
            </h3>
          </div>
            ...
            {approvedQuotations.length > 0 ? (
              <div className="space-y-4">
                {approvedQuotations.map((quotation) => (
                  <div key={quotation.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                    <div className="flex-1">
                      <div className="flex items-center gap-4">
                        <div>
                          <p className="font-semibold text-gray-800">{quotation.id}</p>
                          <p className="text-sm text-gray-600">{quotation.client} - {quotation.project}</p>
                        </div>
                        <div className="text-right">
                          <p className="font-bold text-green-600">{quotation.amount}</p>
                    ...
                    <button 
                      ...
                      className="bg-gradient-to-r from-indigo-500 to-indigo-600 text-white px-6 py-2 rounded-lg hover:from-indigo-600 hover:to-indigo-700 transition-all duration-200 font-medium"
                    >
                      Generate Invoice
                    </button>
                  </div>
              ...
              <div className="text-center py-8">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-2">No Approved Quotations</h3>
                <p className="text-gray-600">No quotations are ready for invoice generation.</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
          <div className="bg-gradient-to-r from-green-600 to-emerald-600 px-6 py-4">
            <h3 className="text-xl font-bold text-white flex items-center">
              <span className="mr-2">🧾</span>
              Generate Invoice - {invoiceData.quotationId}
            </h3>
          </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              <h4 className="font-semibold text-gray-800 mb-3">Client Information</h4>
            ...
            <div className="bg-green-50 p-4 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <input 
                    type="text" 
                    className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 outline-none font-semibold"
                ...
                <div>
                  ...
                  <input 
                    type="text" 
                    className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 outline-none font-bold text-green-700"
            ...
            <div className="flex gap-4 pt-4">
              <button className="bg-gradient-to-r from-green-500 to-green-600 text-white px-8 py-3 rounded-lg hover:from-green-600 hover:to-green-700 font-semibold shadow-lg hover:shadow-xl transition-all duration-200">
                Generate Invoice
              </button>
              <button className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-8 py-3 rounded-lg hover:from-blue-600 hover:to-blue-700 font-semibold shadow-lg hover:shadow-xl transition-all duration-200">
                Preview Invoice
              </button>
              <button 
                onClick={() => setShowForm(false)}
                className="bg-gradient-to-r from-gray-500 to-gray-600 text-white px-8 py-3 rounded-lg hover:from-gray-600 hover:to-gray-700 font-semibold shadow-lg hover:shadow-xl transition-all duration-200"
              >
                Cancel
              </button>
            </div>
