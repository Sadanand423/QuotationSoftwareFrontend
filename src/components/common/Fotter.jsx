        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="space-y-4 text-center sm:text-left">
            ...
            <div className="flex space-x-3 justify-center sm:justify-start">
              <a href="#" className="bg-cyan-600 p-2 rounded-full hover:bg-cyan-700">
          ...
          <div className="text-center sm:text-left">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start space-x-3 justify-center sm:justify-start">
                ...
                <p className="text-left">Office No. 102-B, First Floor, Business Commercial -A, Survey No. 21/18-21/24, Tech Road, Your City - 411027</p>
              </div>
              ...
              <div className="flex items-center space-x-3 justify-center sm:justify-start">
                ...
                <p>info@quotationsoftware.com</p>
              </div>
            </div>
          </div>
        </div>
