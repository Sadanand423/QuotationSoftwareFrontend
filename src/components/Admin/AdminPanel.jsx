  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-100">
      ...
      <div className="flex-1 overflow-auto">
        <header className="bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 shadow-lg border-b border-gray-700 px-3 sm:px-6 py-4 sticky top-0 z-10">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <button
                onClick={() => setSidebarOpen(!sidebarOpen)}
                className="lg:hidden mr-3 p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700"
              >
              ...
              <div>
                <h1 className="text-lg sm:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                  <span className="hidden sm:inline">Quotation Management System</span>
                  <span className="sm:hidden">QMS</span>
                </h1>
                <p className="text-xs sm:text-sm text-gray-400 mt-1 hidden sm:block">Professional Business Solutions</p>
              </div>
            </div>
