        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="text-center mb-16">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 mb-6">
              Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Features</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Comprehensive solutions powered by advanced technology and data science
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid lg:grid-cols-3 gap-8">
            {/* Data Science */}
            <div className="bg-white rounded-3xl shadow-2xl p-8 border border-white/20 hover:transform hover:scale-105 transition-all duration-300">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Advanced statistical analysis, machine learning models, and predictive analytics 
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-8 border border-white/20 hover:transform hover:scale-105 transition-all duration-300">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Intelligent automation and AI-powered solutions to streamline processes 
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-8 border border-white/20 hover:transform hover:scale-105 transition-all duration-300">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Comprehensive BI solutions with interactive dashboards and real-time 
                reporting for informed business decisions.
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center">
                  <svg className="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="py-16 bg-white/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Why Choose Smart Matrix?</h2>
          </div>
